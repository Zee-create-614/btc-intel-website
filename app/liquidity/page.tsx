    ...
    <div className="min-h-screen bg-slate-900 text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <Card className="bg-slate-800 border-slate-700 mb-8">
          <CardHeader>
            <CardTitle className="flex justify-between items-center">
              <span>Composite Liquidity Score</span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-slate-400">US M2 Money Supply</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-slate-400">Fed Balance Sheet</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-slate-400">Net Fed Liquidity</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-slate-400">Reverse Repo</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-slate-400">Treasury General Account</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-slate-400">Credit Spread</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-slate-400">US Dollar Index (DXY)</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-slate-400">ECB Assets</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-blue-400">
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-slate-400">BoJ Assets</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-green-400">
        ...
        <Card className="bg-slate-800 border-slate-700 mt-8">
          <CardHeader>
            <CardTitle>How the Liquidity Score Works</CardTitle>
          </CardHeader>
